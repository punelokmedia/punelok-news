                ...
                {news.length === 0 ? (
                    <div className="py-20 text-center border-2 border-dashed border-gray-100 rounded-3xl">
                        <p className="text-gray-400 font-bold uppercase tracking-widest">
                            {language === 'marathi' ? 'लवकरच येत आहे...' : language === 'hindi' ? 'जल्द ही आ रहा है...' : 'Coming Soon...'}
                        </p>
                    </div>
                ) : (
                            ...
                            <Link href={`/news/${item._id}`} key={item._id} className="group flex flex-col no-underline">
                                ...
                                <div className="flex items-center gap-2 mb-2 text-[10px] font-black tracking-widest">
                                    <span className="text-red-600 uppercase">
                                        {(slug === 'maharashtra') ? (language === 'marathi' ? 'महाराष्ट्र' : language === 'hindi' ? 'महाराष्ट्र' : 'MAHARASHTRA') : slug.toUpperCase()}
                                    </span>
